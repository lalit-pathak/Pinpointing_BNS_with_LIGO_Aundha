...
def generate_sim_data(inj_approx, fLow, segLen, ifos, inj_params, noise_seed):
    ...
    for ifo in ifos:
        ...
        if(ifo=='V1'):
            ...
            psds[ifo] = load_frequencyseries(os.getcwd() + '/../../../../psds/PSD_O4_10Hz_to_2048Hz_nonzero.txt')
...
def generate_covmat(fiducial_params, ifos):
    ...
    for ifo in ifos:
        ...
        if(ifo=='V1'):
            ...
            ifo_mod = 'LIGOI'
            LVKA_detectors[ifo_mod]['psd_path'] = os.getcwd() + '/../../../../psds/PSD_{}_10Hz_to_2048Hz_nonzero.txt'.format(A0_PSD)
