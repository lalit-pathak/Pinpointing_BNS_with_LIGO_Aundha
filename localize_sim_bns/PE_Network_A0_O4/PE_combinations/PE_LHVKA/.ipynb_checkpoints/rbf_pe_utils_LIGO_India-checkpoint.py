...
def generate_covmat(fiducial_params, ifos):
    ...
    for ifo in ifos:
        ...
        if(ifo=='V1'):
            ...
            ifo_mod = 'Virgo'
            LVKA_detectors[ifo_mod]['psd_path'] = os.getcwd() + '/PSD_{}_10Hz_to_2048Hz_nonzero.txt'.format(ifo_mod)
            ...
            ifo_mod = 'LIGOI'
            LVKA_detectors[ifo_mod]['psd_path'] = os.getcwd() + '/psd/PSD_{}_10Hz_to_2048Hz_nonzero.txt'.format(A0_PSD)

        else:

            LVKA_detectors[ifo]['psd_path'] = os.getcwd() + '/PSD_O5_10Hz_to_2048Hz_nonzero.txt'
...
#-- subroutine to generate rbf nodes ---
def generate_nodes(fiducial_params, nodes_params, ifos, fLow):
    ...
    if(nodes_params['nodes_gauss_num'] != 0):
        ...
        cov_mat = generate_covmat(fiducial_params, ifos)
...
def start_up(fiducial_params, data_params, waveform_params, rbf_params, nodes_params, \
    ...
    st = time.time()
    nodes = generate_nodes(fiducial_params, nodes_params, ifos, waveform_params['fLow'])
    et = time.time()
