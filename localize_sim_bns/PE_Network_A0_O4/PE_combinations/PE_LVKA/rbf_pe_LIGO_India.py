...
combination = 'L1V1K1A0'  #-- Along with this always change the 'ifos' defined inside the main loop below --
...
noise_param = 4    #-- (same as LVK) this value will change and be saved for every combination (say LHVK or LHV or HLV)
...
for count in range(total_injections):
    ...
    ifos = ['L1', 'V1', 'K1', 'A0']       # list of available detectors for the given event
