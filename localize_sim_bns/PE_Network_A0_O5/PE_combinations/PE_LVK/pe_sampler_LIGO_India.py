...
def generate_postSamps(raw_samples, ifos, count, save_to_hdf=False):
    ...
    if(save_to_hdf):
        ...
        with h5py.File(os.getcwd() + '/post_samples/post_samples_interp_SNR_20to25_{}.hdf'.format(name), 'a') as file_eff :
