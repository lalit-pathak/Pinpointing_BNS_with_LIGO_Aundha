...
combination = 'H1V1A0'  #-- Along with this always change the 'ifos' defined inside the main loop below --
...
noise_param = 13    #-- this value will change and be saved for every combination (say LHVK or LHV or HLV)
...
for count in range(total_injections):
    ...
    ifos = ['H1', 'V1', 'A0']       # list of available detectors for the given event
