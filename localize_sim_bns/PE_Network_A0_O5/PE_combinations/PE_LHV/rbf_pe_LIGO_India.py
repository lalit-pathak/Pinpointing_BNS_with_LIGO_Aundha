...
combination = 'L1H1V1'  #-- Along with this always change the 'ifos' defined inside the main loop below --
...
noise_param = 2    #-- this value will change and be saved for every combination (say LHVK or LHV or HLV) [to make sure of uncorrelated guassian noise in each detector]
