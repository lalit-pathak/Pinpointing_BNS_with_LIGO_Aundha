...
combination = 'L1H1K1'  #-- Along with this always change the 'ifos' defined inside the main loop below --
...
noise_param = 3    #-- this value will change and be saved for every combination (say LHVK or LHV or HLV) [to make sure of uncorrelated guassian noise in each detector]
...
for count in range(total_injections):
    ...
    ifos = ['L1', 'H1', 'K1']       # list of available detectors for the given event
