...
def generate_covmat(fiducial_params, ifos, segLen, event):
    ...
    for ifo in ifos:
        ...
        if(ifo=='V1'):
            ...
            ifo_mod = 'Virgo'
            LVK_detectors[ifo_mod]['psd_path'] = os.getcwd() + '/psd/{}_PSD_{}.txt'.format(event, ifo)
            ...
            LVK_detectors[ifo]['psd_path'] = os.getcwd() + '/psd/{}_PSD_{}.txt'.format(event, ifo)
    ...
    totF = myLVK_Net.FisherMatr(myEvent_dict, df= 1/segLen, use_m1m2=True) # replace df=1/360 by an appropriate variable name
