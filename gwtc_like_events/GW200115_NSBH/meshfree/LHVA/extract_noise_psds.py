   ...
   #-- dictionaries --
    ...
    for ifo in ifos:
        ...
        if (ifo !='A0') :
            ...
            strain[ifo] = load_timeseries(os.getcwd()+'/../../{}_post_merger_only_noise_1263097607-5000.hdf'.format(event),\
    ...
    st_L1 = 1263097607 + initial_gap              # start time for L, H and V dets
