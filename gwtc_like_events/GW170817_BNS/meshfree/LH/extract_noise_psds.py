   ...
   #-- dictionaries --
    ...
    for ifo in ifos:
        ...
        if (ifo !='A0') :
            ...
            strain[ifo] = load_timeseries(os.getcwd()+'/../../{}_post_merger_only_noise_1187009082-5000.hdf'.format(event),\
    ...
    st_L1 = 1187009082 + initial_gap              # start time for L, H and V dets
